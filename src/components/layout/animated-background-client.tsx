...
const AnimatedBackgroundClient = () => {
  ...
  // Set mounted to true only after the component mounts on the client
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  useEffect(() => {
    // Only run the animation effect if the component is mounted
    if (!mounted) return;
         ...
         {isDark && (
            <>
                <Image 
                    ...
                    width={400} 
                    height={400} 
                    className="absolute top-[10%] w-64 h-64 opacity-20 animate-float"
                />
                <Image 
                    src="/big_2.png" 
                ...
                />
                 <Image 
                    ...
                    width={150} 
                    height={150} 
                    className="absolute top-[50%] w-24 h-24 opacity-10 animate-float-fast"
                />
                <Image 
                    src="/small_2.png" 
                    ...
                    width={150} 
                    height={150} 
                    className="absolute bottom-[30%] w-32 h-32 opacity-15 animate-float-slow"
                />
            </>
        )}
    </div>
